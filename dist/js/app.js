...
document.querySelector('.interior-menu').addEventListener('click', (event) => {
  if (event.target.classList.contains('interior-menu__text')) {
    document
      .querySelectorAll('.interior-menu__text')
      .forEach((item) => item.classList.remove('interior-menu__text_active'));
...
document.querySelector('.header-menu').addEventListener('click', (event) => {
  if (event.target.classList.contains('header-menu__link')) {
    document
      ...
      .forEach((item) => item.classList.remove('header-menu__link_active'));
